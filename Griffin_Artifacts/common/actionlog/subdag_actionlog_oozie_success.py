...
def sub_dag(parent_dag_name, child_dag_name, start_date, schedule_interval,cluster_id,aws_conn_id,check_interval,JOB_PROPS):
    with models.DAG(
        ...
        run_success_oozie = EmrSubmitAndMonitorStepOperator(
            task_id="run_success_oozie",
            steps=[
                {
                    "Name": "run_success_oozie_" + parent_dag_name,
