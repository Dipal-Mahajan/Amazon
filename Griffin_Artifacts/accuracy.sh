...
sudo su -l root -c "aws s3 cp --recursive $path/persist/accuracy/ $env_code/griffin/output/accuracy/"
sudo su -l root -c "aws s3 sync $path/persist/accuracy/ $env_code/griffin/output/accuracy/"
